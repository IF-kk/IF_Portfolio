...
const services = [
  {
    ...
    description:
      "架空のテクノロジー企業を想定し、企業のコアバリューや先進性を視覚的に伝えるプロモーション映像を制作しました。単に美しいグラフィックを作るだけでなく、「ターゲットにどう印象付けるか」というビジネス側の目的から逆算して構成を設計しています。テンポの良いカット割りと、意味を持たせたモーショングラフィックスを組み合わせることで、短い時間で視聴者の心を惹きつける表現を追求しました。",
    number: "01",
    videoId: "GAAP6U3XdbY",
  },
  {
  ...
  },
  {
    title: "Youtube動画編集",
    description:
      "依頼者様のイメージを具現化し、視聴者を惹きつける動画を制作します。\n\n目的に合わせた最適なシナリオ作成からサポート可能。世界観にマッチしたテロップデザインやSE・BGM選定はもちろん、飽きさせないテンポの良いカット割りとアニメーション豊かな演出で、動画のクオリティを一段引き上げます。",
    number: "04",
    videoId: "GL9ReHFRcbU",
  },
  {
    title: "Short動画編集",
    description:
      "短い時間で最大のインパクトを残す、エンゲージメントの高いショート動画を制作します。\n\nスワイプされない圧倒的なテンポ感と、視覚に訴えかけるアニメーション演出が特徴です。トレンドを意識したBGM・SE選定や、要点を押さえた魅力的なテロップで、視聴者の心を一瞬で掴む映像体験を提供します。",
    number: "05",
    videoId: "tleyEB8NJJ8",
  },
];
